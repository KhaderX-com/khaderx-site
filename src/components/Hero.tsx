...
export default function Hero({ className = '' }: HeroProps) {
    return (
        <section
            className={`relative w-full min-h-screen h-screen overflow-hidden ${className}`}
        >
            {/* Gradient Background */}
            ...
            <div className="absolute inset-0 flex items-center justify-start px-4 sm:px-6 md:px-8 lg:px-12">
                <div className="text-left text-[#0A2540] z-10 w-full sm:w-4/5 md:w-3/5 lg:w-2/5 xl:w-1/3 max-w-lg">
                    ...
                    <div className="flex flex-wrap items-center gap-3 sm:gap-4 mt-4 sm:mt-6">
                        <a
                            ...
                            className="p-3 sm:p-4 bg-[#0A2540] text-white rounded-full hover:bg-gray-800 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-400/50 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2"
                        >
                            <svg
                    ...
                    {/* <a
                        href="#projects"
                        className="block mt-8 px-8 py-4 bg-cyan-500 hover:bg-cyan-600 text-white font-semibold text-lg rounded-lg shadow-lg hover:shadow-xl hover:shadow-cyan-400/30 transition-all duration-300 hover:scale-105 text-center"
                    >
                        Explore My Projects
                    </a> */}
                </div>
