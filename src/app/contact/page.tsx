...
function InfoCard({ title, icon, children }: InfoCardProps) {
    return (
        <div className="group relative">
            <div className="relative bg-gradient-to-br from-gray-900/90 to-black/95 backdrop-blur-md border border-gray-800/50 rounded-2xl p-8 h-full transition-all duration-500 hover:border-cyan-400/30 hover:shadow-2xl hover:shadow-cyan-400/10 hover:-translate-y-1">
                ...
                <div className="relative z-10">
                    ...
                    {/* Title */}
                    <h3 className="text-2xl font-bold text-white mb-6 font-heading group-hover:text-cyan-50 transition-colors duration-300">
                        {title}
                    </h3>
        ...
        <PageTransition>
            <div className="min-h-screen bg-black">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center justify-center p-2 bg-cyan-400/10 rounded-full mb-6">
                        <div className="w-2 h-2 bg-cyan-400 rounded-full animate-pulse"></div>
                        <span className="mx-3 text-cyan-400 text-sm font-medium uppercase tracking-wider">Professional Contact</span>
                        <div className="w-2 h-2 bg-cyan-400 rounded-full animate-pulse"></div>
                    </div>
                    ...
                    >
                        <div className="space-y-4">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <p className="font-semibold text-white">ABUELTAYEF Khader</p>
                                    <p className="text-gray-400 text-sm">Aerospace | Aeronautical | Mechanical Engineer | Python Developer</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <div>
                                    <p className="text-white font-medium">contact@khaderx.com</p>
                                    <p className="text-gray-400 text-sm">abueltayef.khader@gmail.com</p>
                                </div>
                            </div>
