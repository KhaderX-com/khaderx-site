            ...
            <main className="container mx-auto px-4 py-12 pt-24 max-w-6xl">
                ...
                <div className="text-center mb-12">
                    ...
                    <div className="flex justify-center mb-12">
                        ...
                        >
                            ...
                            Contact Me
                            <span className="ml-2 text-sm opacity-90">contact@khaderx.com</span>
                        </a>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-8">
                        <div className="flex items-center mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-[#0A2540]">Personal Information</h2>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <p className="font-semibold text-[#0A2540]">ABUELTAYEF Khader</p>
                            ...
                            <div className="flex items-center">
                                ...
                                <div>
                                    <p className="text-[#0A2540]">abueltayef.khader@gmail.com</p>
                                    <p className="text-gray-600">abueltayef.khader.main@hotmail.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <p className="text-[#0A2540]">+32 483 817 658</p>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <p className="text-[#0A2540]">Belgium</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-8">
                        <div className="flex items-center mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-[#0A2540]">Languages</h2>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {[
                                ...
                                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    <span className="font-medium text-[#0A2540]">{language.name}</span>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                    <div className="flex items-center mb-6">
                        ...
                        <h2 className="text-2xl font-bold text-[#0A2540]">Education</h2>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="border-l-4 border-cyan-500 pl-6">
                            ...
                            <h3 className="text-lg font-semibold text-[#0A2540]">Bachelor in Civil Engineering</h3>
                        ...
                        <div className="border-l-4 border-cyan-500 pl-6">
                            ...
                            <h3 className="text-lg font-semibold text-[#0A2540]">CESS</h3>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                    <div className="flex items-center mb-6">
                        ...
                        <h2 className="text-2xl font-bold text-[#0A2540]">Skills & Expertise</h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h3 className="text-lg font-semibold text-[#0A2540] mb-4">Programming</h3>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-[#0A2540] mb-4">Software & Tools</h3>
                            <div className="space-y-2">
                                {[
                                    'Microsoft Office',
                                    'NX Siemens',
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                    <div className="flex items-center mb-6">
                        ...
                        <h2 className="text-2xl font-bold text-[#0A2540]">Links & Profiles</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        >
                            ...
                            <div>
                                <p className="font-medium text-[#0A2540] group-hover:text-cyan-700">GitHub</p>
                        ...
                        >
                            ...
                            <div>
                                <p className="font-medium text-[#0A2540] group-hover:text-cyan-700">PyPI</p>
                        ...
                        <a
                            ...
                            className="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-cyan-50 transition-colors duration-300 group"
                        >
                            <svg className="w-8 h-8 text-blue-600 group-hover:text-blue-700 mr-3" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                            </svg>
                            <div>
                                <p className="font-medium text-[#0A2540] group-hover:text-cyan-700">LinkedIn</p>
                        ...
                        >
                            ...
                            <div>
                                <p className="font-medium text-[#0A2540] group-hover:text-cyan-700">Blog</p>
                        ...
                        >
                            ...
                            <div>
                                <p className="font-medium text-[#0A2540] group-hover:text-cyan-700">Gravatar</p>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8">
                    <div className="flex items-center mb-6">
                        ...
                        <h2 className="text-2xl font-bold text-[#0A2540]">Additional Information</h2>
                    </div>
