                        ...
                        {/* <div className="mt-12 pt-8 border-t border-gray-200">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <span className="text-gray-700">Aerospace Engineering Projects</span>
                                </div>

                                <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                                    <div className="w-3 h-3 bg-[#00C2FF] rounded-full mr-3"></div>
                                    <span className="text-gray-700">Python Applications</span>
                                </div>

                                <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                                    <div className="w-3 h-3 bg-[#00C2FF] rounded-full mr-3"></div>
                                    <span className="text-gray-700">Flutter Mobile Apps</span>
                                </div>
